...
<header class="" >
     ...
     <nav class="per-container navbar">
      <a href="{{route('acceuil')}}" class="logo-img"> <img src="{{asset('images/logo-udemy.png')}}" alt="logo"></a>
       ...
       <div class="search">
        ...
        <ul class="menu-list">
         ...
         <li><a href="{{route('favoris')}}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-heart"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg></a></li>
         <li class="account">
            ...
            <div class="dropdown-acc invisible" id="dropdown-acc">
                ...
                <div class="dropdown-links">
                    <ul class="dropdown-links-list">
                        <li><i class="bi bi-clock-history"> Historique</i></li>
                        <li> 
   ...
   <script>
        ...
        function DropdownToggle(){
            drop_down_view.classList.toggle('invisible')
        }
        drop_down_btn.addEventListener('click',DropdownToggle)
