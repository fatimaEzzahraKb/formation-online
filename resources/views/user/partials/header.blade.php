<div class="responsive-search-page " id="search-page">
    <img src="{{asset('images/close.png')}}" id="close-search" alt="">
      ...
      <input type="text" placeholder="Rechercher..." class="search-input" id="search-input-resp"/>
      </div>
     ...
     <nav class="per-container navbar">
      <a href="{{route('acceuil')}}" class="top logo-img"> <h1><span class="V"> V</span> Formations</h1>
       ...
       <div class="search">
        ...
        <menu class="menu">
        <ul class="menu-list">
         <li><a href="{{route('acceuil')}}" class="text-link {{request()->is('acceuil') ? 'active-link' : '' }} ">Accueil</a></li>
         <li><a href="{{route('about')}}"class="text-link {{request()->is('about') ? 'active-link' : '' }} " >à propos</a></li>
         <li><a href="{{route('favoris.index')}}"><svg  class=" {{request()->is('favoris') ? 'active-link-icon' : '' }} "  xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-heart"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg></a></li>
         <li class="account">
